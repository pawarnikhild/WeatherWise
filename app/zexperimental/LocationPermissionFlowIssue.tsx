/**
 * Work in Progress: Location Permission Flow
 *
 * Status: This is flow of getting permission and location enablement. It is working but due to behavior of android it not working as intended.
 *
 * Known Issues:
